...
const AppointmentPage: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Mock registration request with sample data
      ...
      setError('Failed to register appointment. Please try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="kiosk-container">
      <div className="kiosk-header">
        <h1 className="kiosk-title">Select Appointment</h1>
        <p className="kiosk-subtitle">Choose your preferred date and time</p>
      </div>
